...
src_prepare() {
	#workaround for 115.29
	rm -v "${WORKDIR}"/firefox-patches/*0033-bmo-1882209*.patch || die
...
src_configure() {
	...
	# Modify Rustflags to suppress "warning: unexpected cfg condition name: doc_cfg" (genr8 mod)
