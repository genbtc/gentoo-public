...
mksquashfs livegui-amd64-20230705T183202Z livegui-amd64-20230705T183202Z.squashfs -wildcards -ef ~/exclude-squashfs.txt -b 1024K -comp xz -progress -processors 16 -Xdict-size 100% -noappend
